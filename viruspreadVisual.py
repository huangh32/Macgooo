...
GREY = (0.8, 0.8, 0.8)  # this is for the uninfected
RED = (1, 0, 0)         # this is for the infected
GREEN = (0, 1, 0.0)     # this is for the recovered 
BLACK = (0, 0, 0)       # and this is the fatality/death

COVID19_PARAMS = {
    "r0": 2.5,                      #basic production rate
    "incubation": 5,                #incubation period
    "percent_mild": 0.8,            #percentage of mild cases
    "mild_recovery": (7, 14),       #mild cases recovery rate
    "percent_severe": 0.2,          #percentage of severe cases
    "severe_recovery": (21, 42),    #severe cases recovery rate
    "severe_death": (14, 56),       #severe cases death rate
    "fatality_rate": 0.034,         #total fatality rate
    "serial_interval": 7            
}
